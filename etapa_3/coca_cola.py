...
class Individuo():
    ...
    def calcula_fitness(cromossomo):
        coca = int(str(cromossomo[0]) + str(cromossomo[1]) + str(cromossomo[0]) + str(
            cromossomo[2]))  # concatena as posições do SEND
        # print("SEND ", send)
        cola = int(str(cromossomo[0]) + str(cromossomo[1]) + str(cromossomo[3]) + str(
            cromossomo[2]))  # concatena as posições do MORE
        # print("MORE", more)
        oasis = int(str(cromossomo[1]) + str(cromossomo[2]) + str(cromossomo[4]) + str(cromossomo[5]) + str(
            cromossomo[4]))  # concatena as posições do MONEY
        # print("MONEY", money)
        ...
        fitness1 = abs((coca + cola) - oasis)  # Calcula a avaliação Avaliação
        return fitness1
