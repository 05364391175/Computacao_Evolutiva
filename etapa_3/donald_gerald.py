...
class Individuo():
    ...
    def calcula_fitness(cromossomo):
        donald = int(str(cromossomo[0]) + str(cromossomo[1]) + str(cromossomo[2]) + str(
            cromossomo[3]) + str(cromossomo[4]) + str(cromossomo[0]))
        gerald = int(str(cromossomo[5]) + str(cromossomo[6]) + str(cromossomo[7]) + str(
            cromossomo[3]) + str(cromossomo[4]) + str(cromossomo[0]))
        robert = int(str(cromossomo[7]) + str(cromossomo[1]) + str(cromossomo[8]) + str(
            cromossomo[6]) + str(cromossomo[7]) + str(cromossomo[9]))
        fitness1 = abs((donald + gerald) - robert)  # Calcula a avaliação Avaliação
        # print(fitness1)
        return fitness1
